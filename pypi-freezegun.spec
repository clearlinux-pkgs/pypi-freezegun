...
Provides: freezegun
Provides: freezegun-python
Provides: freezegun-python3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641436839
...
cp %{_builddir}/freezegun-1.1.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-freezegun/83ff4be984d95e17546d5eaa6e14beba8ef4b5e9
