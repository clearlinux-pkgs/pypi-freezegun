...
Source0  : https://files.pythonhosted.org/packages/c7/75/0455fa5029507a2150da59db4f165fbc458ff8bb1c4f4d7e8037a14ad421/freezegun-1.5.2.tar.gz
...
%prep
%setup -q -n freezegun-1.5.2
cd %{_builddir}/freezegun-1.5.2
pushd ..
cp -a freezegun-1.5.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748370671
